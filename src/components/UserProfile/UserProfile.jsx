...
import avatarImg from "../../Asset/images.png";
const UserProfile = () => {
  ...
  return (
    <div className="flex justify-center  mt-20 h-screen ">
      {user ? (
        <div className="max-w-lg h-52 p-8 sm:flex sm:space-x-6 bg-white shadow-xl text-gray-900 flex items-center">
              ...
              <div className="flex flex-wrap gap-x-2 gap-y-2">
                <div className="relative flex-shrink-0">
                  ...
                  <img
                    ...
                    alt=""
                    className="border w-32 h-32 rounded-full  border-gray-700"
                  />
                </div>
              </div>
            </div>
    ...
    //       <p>{user?.email}</p>
    //       {user?.emailVerified ? <p>True</p> : <p>False</p>}
    //     </div>
    //   ) : (
    //     <p>No user found</p>
    //   )}
